...
def post_process_text(raw_text, max_length=300):
    """
    Cleans up or formats raw generated text for display or output.

    Args:
        raw_text (str): The raw text generated by a model.
        max_length (int): Maximum number of characters to keep.

    Returns:
        str: Post-processed and truncated text.
    """
    if not isinstance(raw_text, str):
        return ""

    # Basic cleanup: strip whitespace, remove line breaks, etc.
